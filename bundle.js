...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _api_clients_TMDBClient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api/clients/TMDBClient */ \"./src/api/clients/TMDBClient.ts\");\n/* harmony import */ var _assets_common_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/common.css */ \"./src/assets/common.css\");\n/* harmony import */ var _components_MovieList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/MovieList */ \"./src/components/MovieList.ts\");\n/* harmony import */ var _states_NewMovie__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./states/NewMovie */ \"./src/states/NewMovie.ts\");\n\n\n\n\nconst client = new _api_clients_TMDBClient__WEBPACK_IMPORTED_MODULE_0__.TMDBClient({\n    apiKey: \"74d3b7c1f3d2fa03bf72ed1f6f9cca12\",\n});\nfunction assignMovieList(movieList) {\n    document.querySelector('main').replaceChildren(movieList.render());\n}\nassignMovieList(new _components_MovieList__WEBPACK_IMPORTED_MODULE_2__.MovieList('지금 인기있는 영화', new _states_NewMovie__WEBPACK_IMPORTED_MODULE_3__.NewMovie((page) => client.getPopularMovies({ page }))));\ndocument.querySelector('.logo').addEventListener('click', () => {\n    assignMovieList(new _components_MovieList__WEBPACK_IMPORTED_MODULE_2__.MovieList('지금 인기있는 영화', new _states_NewMovie__WEBPACK_IMPORTED_MODULE_3__.NewMovie((page) => client.getPopularMovies({ page }))));\n});\ndocument.querySelector('.search-box').addEventListener('submit', (event) => {\n    event.preventDefault();\n    const formData = Object.fromEntries(new FormData(event.target).entries());\n    const query = formData['search-text'];\n    assignMovieList(new _components_MovieList__WEBPACK_IMPORTED_MODULE_2__.MovieList(`\"${query}\" 검색결과`, new _states_NewMovie__WEBPACK_IMPORTED_MODULE_3__.NewMovie((page) => client.searchMovies({ query, page }))));\n});\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/index.ts?");

/***/ }),

/***/ "./src/states/NewMovie.ts":
/*!********************************!*\
  !*** ./src/states/NewMovie.ts ***!
  \********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"NewMovie\": () => (/* binding */ NewMovie)\n/* harmony export */ });\n/* harmony import */ var _Subject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Subject */ \"./src/states/Subject.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\n\nclass NewMovie extends _Subject__WEBPACK_IMPORTED_MODULE_0__.Subject {\n    constructor(fetchFn) {\n        super();\n        this.fetchFn = fetchFn;\n        this.page = 1;\n        this.isFinished = false;\n    }\n    fetchNextPage() {\n        return __awaiter(this, void 0, void 0, function* () {\n            if (this.isFinished)\n                return;\n            const page = this.page;\n            this.page += 1;\n            const promise = this.fetchFn(page);\n            const promises = [...Array(20)].map((_, index) => new Promise((resolve) => {\n                promise\n                    .then((response) => { var _a; return resolve((_a = response.movies[index]) !== null && _a !== void 0 ? _a : null); })\n                    .catch(() => {\n                });\n            }));\n            promises.forEach((_promise) => {\n                const movieSubject = _Subject__WEBPACK_IMPORTED_MODULE_0__.Subject.ofPromise(_promise);\n                this.next(movieSubject);\n            });\n            try {\n                const { totalPages } = yield promise;\n                if (page >= totalPages) {\n                    this.isFinished = true;\n                }\n            }\n            catch (e) {\n                const error = e;\n                this.error(error);\n            }\n        });\n    }\n}\n\n\n//# sourceURL=webpack://javascript-movie-review/./src/states/NewMovie.ts?");
